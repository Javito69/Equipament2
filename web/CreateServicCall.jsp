...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function control2()
            {
                f.Esol.value = " Descripció de equipament: " + f.Esol2.value + "\n";
            ...
            function MostraDetall2(control)
            {
                ...
                while (detalls != "")
                {
                    ...
                    if (detallAct != "")
                        document.all("Detall" + detallAct).style.display = "block";
                }
                    ...
                    <table border="0">
                        ...
                        <tr>
                            <td colspan=8 class="texto">
                                ...
                                <p>
                                    <input type="submit" value="<%= bean.findLabel("SP_Submit") %> &raquo;" onclick="this.disabled = true;
                                            this.value = 'Enviant dades, espereu si us plau...';
                                            this.form.submit();">
                                </p></td>
                        </tr>
                        <td class="texto">
                            ...
                            <div id=DetallAmbit style="display: none">
                                <b>Ã?mbit<b><br>
                                        <select class="texto" name="Ambit" size="1">
                                            ...
                                            <option value="MetropolitÃ ">MetropolitÃ </option>
                                ...
                                <div id=DetallDestinatari style="display: none">
                                    <b>Destinatari<b><br>
                                            <select name="Destinatari" class=texto onchange="MostraDetall(this);">
                                                <option value="" tipDetall=""></option>
                                                <option value="persona" tipDetall="Persona,Confidencial">Persona fÃ­sica</option>
...
if (_description != null) description = "Equipament Informàtic" ; 
...
%> <%= bean.findLabel("SP_ObjectWhere") %> <%
  ...
  String categoria = "Petició a mida";
...
// XDG comprovació de tipus de equipament i tipus d'actuació
           ...
           if ("Ordinador sobretaula".equals(tipopeticion)){
                   tipusEquipament="PC";
           }else if ("Ordinador portàtil".equals(tipopeticion)){
                   tipusEquipament="Portàtil";
           }else {
