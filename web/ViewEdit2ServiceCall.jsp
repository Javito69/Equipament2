...
<%
  ...
  String _sc_anterior_id = request.getParameter("vSc1");
  String _sc_actual_id = request.getParameter("vSc2");
  Long sc_oid = null;
                ...
                <%
                  if (sc_ent.isRequiredID()) {
                    %>
                      ...
                      <B>La seva petició s'ha creat amb l'identificador <%= _sc_anterior_id %> (Instal·lació)</B>
                      <BR>
                      <B>La seva petició s'ha creat amb l'identificador <%= _sc_actual_id %> (Retirada)</B>
                      <BR>
                    <%
                  } else {
                    %>
